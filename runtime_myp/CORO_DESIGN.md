...
> 状态：**设计稿 + Phase A/B/C 已实施（2026-08-25 #36/#37/#38）**。
...
> **Phase C channel（create/send/recv/try/close/destroy/size + 同步交接）+ future
> （create/set/get/destroy + coro wait/wake/am_i_coro）**。
> 待实施：exec worker 非阻塞、栈池、cleanup（Phase C 尾，见 §4）。
