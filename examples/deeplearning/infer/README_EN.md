...
**Rope** rotary position embeddings), training backward ops (incl. BN/IN scale·bias grads & 4D/batch MatMul backward), Dropout infer/train semantics. Real models:
...
../infer_tests/        # end-to-end regression (135 *_main.myp, see infer_tests/README.md)
