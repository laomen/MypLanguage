...
names=(sieve matmul nbody mandelbrot hashmap tripleloop raytracer gol fft astar sha256 quicksort nqueens bst dijkstra base64 alphabeta spmv kmeans bigint huffman convolution knapsack kmp radixsort sobel floyd heapsort crc32 dotprod)
mkdir -p out
